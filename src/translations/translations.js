...
export const translations = {
  en: {
    ...
    marketplace: {
      ...
      formSubtitle: "Complete the form. Once reviewed, your business will appear in the directory.",
      close: "Close",
      form: {
        businessName: "Business name",
        businessNamePlaceholder: "E.g.: Salsisa",
        ownerName: "Parent's full name",
        ownerNamePlaceholder: "E.g.: Isabel Páez Mercado",
        email: "Email",
        ...
        descriptionPlaceholder: "Tell us what you sell or offer, how you work, delivery options, etc.",
        descriptionHint: "characters",
        instagram: "Instagram (optional)",
        instagramPlaceholder: "username without @",
        website: "Website (optional)",
        websitePlaceholder: "https://",
        photos: "Photos of your products (optional)",
        ...
        privacyOf: "of The Columbus School Foundation.",
        submit: "Submit registration",
        submitting: "Submitting...",
        required: "Required field",
        invalidEmail: "Enter a valid email",
        invalidWhatsapp: "Enter a valid number (7 to 15 digits)",
        ...
        acceptRequired: "You must accept the data processing policy to continue.",
        ...
        successClose: "Back to directory",
      ...
      categories: {
        ...
        hogar: "Home & Decor",
        bienestar: "Health, Beauty & Wellness",
        servicios: "Education & Professional Services",
        arte: "Art, Gifts & Entertainment",
        tecnologia: "Technology & Others"
      }
    },
  ...
  es: {
    ...
    marketplace: {
      ...
      formTitle: "Registra tu emprendimiento",
      formSubtitle: "Completa el formulario. Una vez revisado, tu emprendimiento aparecerá en el directorio.",
      close: "Cerrar",
      form: {
        businessName: "Nombre del emprendimiento",
        businessNamePlaceholder: "Ej: Salsisa",
        ownerName: "Nombre completo del padre / madre de familia",
        ownerNamePlaceholder: "Ej: Isabel Páez Mercado",
        email: "Correo electrónico",
        ...
        descriptionPlaceholder: "Cuéntanos qué vendes u ofreces, cómo trabajas, opciones de entrega, etc.",
        descriptionHint: "caracteres",
        instagram: "Instagram (opcional)",
        instagramPlaceholder: "usuario sin @",
        ...
        privacyPolicy: "política de tratamiento de datos personales",
        privacyOf: "de la Fundación The Columbus School.",
        submit: "Enviar registro",
        submitting: "Enviando...",
        required: "Campo obligatorio",
        invalidEmail: "Ingresa un correo válido",
        invalidWhatsapp: "Ingresa un número válido (7 a 15 dígitos)",
        ...
        photoInvalidType: "Solo se permiten imágenes JPG, PNG o WEBP",
        acceptRequired: "Debes aceptar la política de tratamiento de datos para continuar.",
        ...
        successClose: "Volver al directorio",
